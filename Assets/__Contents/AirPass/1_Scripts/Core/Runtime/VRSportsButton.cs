...
namespace AirpassUnity.VRSports
{
    ...
    public class VRSportsButton : MonoBehaviour, IVRSportsInteractable
    {
        ...
        public Button UnityBtn => _btn ??= GetComponent<Button>();

        public void SetInteract(bool value)
        {
            UnityBtn.enabled = value;
            enabled = value;
        }
        ...
        public Color interactedColor = new Color(192.0f / 255.0f, 192.0f / 255.0f, 192.0f / 255.0f, 1);
